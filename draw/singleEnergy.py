...
with PdfPages('singleEnergy.pdf') as pp:    
    for prefix in ['/mnt/stage/douwei/Upgrade/0.90',]:
        fig1 = plt.figure()
        ...
        ax1.set(xlim = (0,640), xlabel='Vertex radius/mm', ylabel='Energy/MeV')
        ax1.axhline(2, linestyle='dashed', c='k', label='Truth', linewidth=1)
        ax1.legend()
