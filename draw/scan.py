...
with PdfPages('scan.pdf') as pp:
    for midx in tqdm([2396,]):
        ...
        ax2 = ax1.twinx()
        ax1.plot(0.65*np.array(r)*1000, L, 'g-')
        ax1.axvline(0.65*r[20]*1000, c='k', ls='--', lw=1)
        p1 = ax1.axvline(0.65*r[120]*1000, c='k', ls='--', lw=1, label='Local Minimum')
