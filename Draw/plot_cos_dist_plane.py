...
with tables.open_file('/mnt/stage/douwei/JP_1t_github/coeff/Legendre/Gather/PE/2/80/40.h5','r') as h:
    coeff = h.root.coeff[:]

cut, fitcut = coeff.shape
PMT_pos = np.loadtxt('./PMT.txt')
...
with PdfPages('scan_2d.pdf') as pp:
