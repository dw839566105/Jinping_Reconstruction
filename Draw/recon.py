...
with PdfPages('Recon_h.pdf') as pp:
    for prefix in ['/mnt/stage/douwei/JP_1t_github/recon/point/', '/mnt/stage/douwei/JP_1t_github/recon/point/']:
        for axis in ['x','z']:
    ...
    for prefix in ['/mnt/stage/douwei/JP_1t_github/root/point/', '/mnt/stage/douwei/JP_1t_github/root/point/']:
